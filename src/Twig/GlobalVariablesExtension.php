...
#[AllowDynamicProperties] class GlobalVariablesExtension extends AbstractExtension
{
    ...
    public function getFunctions(): array
    {
        return [
            ...
            new TwigFunction('nombreDemandesTraiteesByValidateur', [$this, 'getNombreDemandesTraiteesByValidateur']),
    ...
    public function getNombreDemandesTraiteesByValidateur(): int
    {
        try {
            // Vérifie si un token existe
            $token = $this->tokenStorage->getToken();
            ...
            $roles = $user->getRoles();
            if (in_array('ROLE_VALIDATEUR', $roles, true)) {
                $nombreDemandesTraiteesByValidateur = $this->demandeRepository->countDemandesTraiteesByValidateur($user);

                return $nombreDemandesTraiteesByValidateur;
            }
