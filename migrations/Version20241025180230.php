 ...
 */
final class Version20241025180230 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE notifications ADD user_id INT NOT NULL, DROP user');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE notifications ADD user VARCHAR(255) DEFAULT NULL, DROP user_id');
    }
}
